...
def train_test_split(dataset):
  ...
  ordered = sorted(dataset) #sorts the copy of list
...
def prepare_dataset(data='dev'):
  ...
  assert data in ['dev', 'train', 'test','sample']
  ...
  if data == 'dev':
    ...
    filename = 'Forsample/TxtData/sample_image_id.txt'
    train = load_set(filename)
    ...
    # descriptions
    train_descriptions = load_clean_descriptions('Forsample/TxtData/descriptions.txt', train)
    test_descriptions = load_clean_descriptions('Forsample/TxtData/descriptions.txt', test)
    print('Descriptions: train=%d, test=%d' % (len(train_descriptions), len(test_descriptions)))
