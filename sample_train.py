...
def train_model(weight = None, epochs = 10):
  # load dataset
  data = ld.prepare_dataset('sample')
  ...
  # save the tokenizer
  dump(tokenizer, open('Forsample/GeneratedData/tokenizer.pkl', 'wb'))
  # index_word dict
  index_word = {v: k for k, v in tokenizer.word_index.items()}
  # save dict
  dump(index_word, open('Forsample/GeneratedData/index_word.pkl', 'wb'))
  ...
  print('Length of Description : %d' % max_length)
  ...
  # filepath = 'Forsample/GeneratedData/model_weightsample.h5'
  ...
  try:
      model.save('Forsample/GeneratedData/model_weight.h5', overwrite=True)
      #model.save_weights('Forsample/GeneratedData/weights.h5',overwrite=True)
  except:
